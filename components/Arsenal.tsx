...
const Arsenal: React.FC = () => {
  return (
    <section
      id="arsenal"
      className="py-24 bg-[#080808] relative border-t border-[#ff003c]/20 overflow-hidden"
    >
      {/* Decorative Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <RevealOnScroll className="mb-16">
          <div className="flex items-center gap-4 mb-2">
            ...
            <span className="text-[#fcee0a] font-mono text-xs tracking-[0.2em]">
              CHARACTER_LOADOUT
            </span>
          </div>
          <GlitchText
            ...
            <div className="h-full bg-[#111] border border-[#333] p-6 hover:border-[#fcee0a] transition-colors group">
              <div className="flex justify-between items-start mb-4">
                <Shield
                  ...
                  size={32}
                />
                <span className="text-[#fcee0a] font-mono text-xs border border-[#fcee0a] px-2 py-0.5">
                  ARMOR_LVL_4
                </span>
              </div>
          ...
          >
            <div className="h-full bg-[#0b0b0b] border-2 border-[#00f0ff] p-6 relative overflow-hidden group flex flex-col">
              ...
              <div className="bg-[#00f0ff]/10 p-4 border border-[#00f0ff]/50 relative mt-auto">
                ...
                <p className="text-[#00f0ff] text-xs font-bold mb-2">
                  &gt;&gt;&gt; ВНИМАНИЕ: ОТДАЧА
                </p>
