...
const CustomCursor = () => {
  ...
  // Don't render on touch devices (simple check) or if off screen initially
  ...
  return (
    ...
    >
      <div className={`relative -translate-x-1/2 -translate-y-1/2 transition-all duration-150 ease-out`}>
        {/* Center Dot */}
        <div className={`w-1 h-1 bg-[#ff003c] rounded-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ${clicked ? 'scale-150' : 'scale-100'}`} />
        ...
        <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300vmax] h-[1px] bg-[#00f0ff] opacity-10 transition-opacity pointer-events-none ${clicked ? 'opacity-30' : ''}`}></div>
        <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1px] h-[300vmax] bg-[#00f0ff] opacity-10 transition-opacity pointer-events-none ${clicked ? 'opacity-30' : ''}`}></div>
      </div>
    </div>
  );
};
